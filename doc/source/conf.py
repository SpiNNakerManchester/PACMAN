...
latex_documents = [
  ('index', 'PACMAN.tex', u'PACMAN Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'PACMAN', u'PACMAN Documentation',
     [u''], 1)
]
...
arguments = [
    ...
    "pacman/model/graphs/application/ap*.py",
    "pacman/model/graphs/[b-z]*/[a-z]*.py",
    "pacman/model/graphs/abstract_*.py",
    "pacman/model/graphs/[go]*.py",
    "pacman/model/partitioner_interfaces/[a-z]*.py",
    "pacman/model/partitioner_splitters/s*.py",
    "pacman/model/partitioner_splitters/abstract*/[a-z]*.py",
