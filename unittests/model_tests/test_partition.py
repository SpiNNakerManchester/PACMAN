...
class TestPartitionConstraints(unittest.TestCase):
    ...
    def test_max_vertex_atoms_constraint(self):
        ...
        self.assertEquals(c1.size, 5)
        self.assertEquals(c1, MaxVertexAtomsConstraint(5))
        self.assertEquals(str(c1), 'MaxVertexAtomsConstraint(size=5)')
    ...
    def test_fixed_vertex_atoms_constraint(self):
        ...
        self.assertEquals(c1.size, 5)
        self.assertEquals(c1, FixedVertexAtomsConstraint(5))
        self.assertEquals(str(c1), 'FixedVertexAtomsConstraint(size=5)')
    ...
    def test_same_atoms_as_vertex_constraint(self):
        ...
        self.assertEquals(c1, SameAtomsAsVertexConstraint(v1))
        self.assertEquals(str(c1), 'SameAtomsAsVertexConstraint(vertex=v1)')
