...
class TestSimulatorData(unittest.TestCase):
    ...
    def test_get_monitors(self):
        ...
        self.assertEqual(0, PacmanDataView.get_all_monitor_sdram())
        self.assertEqual(0, PacmanDataView.get_ethernet_monitor_cores())
        self.assertEqual(0, PacmanDataView.get_ethernet_monitor_sdram())
        ...
        self.assertEqual(200, PacmanDataView.get_all_monitor_sdram())
        self.assertEqual(1, PacmanDataView.get_ethernet_monitor_cores())
        self.assertEqual(200, PacmanDataView.get_ethernet_monitor_sdram())
        ...
        self.assertEqual(target, PacmanDataView.get_all_monitor_sdram())
        self.assertEqual(3, PacmanDataView.get_ethernet_monitor_cores())
        target += 55 + 15 * 45
        self.assertEqual(target, PacmanDataView.get_ethernet_monitor_sdram())
