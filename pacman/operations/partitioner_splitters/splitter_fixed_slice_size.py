...
from pacman.operations.partitioner_splitters.splitter_legacy import \
    SplitterLegacy
...
class SplitterFixedSliceSized(SplitterLegacy):
    ...
    def __init__(self):
        SplitterLegacy.__init__(self, self.SPLITTER_NAME)
        self.__been_called = False
        self.__max_atom_by_constraint = None
        self.__fixed_atom_by_constraint = None

    @overrides(SplitterLegacy.set_governed_app_vertex)
    def set_governed_app_vertex(self, app_vertex):
        SplitterLegacy.set_governed_app_vertex(self, app_vertex)
    ...
    @overrides(SplitterLegacy.create_machine_vertices)
    ...
    @overrides(SplitterLegacy.get_out_going_slices)
    ...
    @overrides(SplitterLegacy.get_in_coming_slices)
