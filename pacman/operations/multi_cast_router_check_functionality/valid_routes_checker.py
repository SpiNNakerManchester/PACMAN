...
def _start_trace_via_routing_tables(
    ...
    :param key_and_mask: the key being used by the partitioned_vertex which resides\
                on the source placement
    :param reached_placements: the placements reached during the trace
    :param n_atoms: the number of atoms going through this path
    :param is_continuous: bool stating if the keys and atoms mapping is
    continuous
    :param failed_to_cover_all_keys_routers: list of failed routers for all keys
    :return: None
...
def _check_all_keys_hit_entry(entry, n_atoms, base_key):
    ...
    :return: the lsit of keys which this entry doesnt cover which it should
    """
    bad_entries = list()
