"""
JsonFileCoder for encoding python obejcts into json files
"""
...
class JsonFileCoder(AbstractFormatCoder):
    """
    JsonFileCoder:  encoder for encoding python obejcts into json files
    """
